...
```bash
通过网盘分享的文件：data
链接: https://pan.baidu.com/s/1XLQT74lqsSAExAETpHVXkA?pwd=8i54 提取码: 8i54
```
...
可从以下地址下载预训练模型：
通过网盘分享的文件：pretrained_weight
链接: https://pan.baidu.com/s/1wBuZxrM3kpbdFp_BAsJfFA 提取码: fak4
